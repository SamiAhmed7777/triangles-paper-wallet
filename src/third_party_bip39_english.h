/*
 * BIP39 English wordlist (2048 words, canonical, from the BIP39 spec).
 *
 * Provenance:
 *   - This is the same wordlist shipped with `triangles_v5` at
 *     src/bip39_english.h, which is the standard BIP39 English wordlist.
 *   - The full canonical list lives upstream at:
 *     https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt
 *
 * License:
 *   - Public domain (the BIP39 wordlist itself is published as public domain).
 *
 * We intentionally use the EXACT same list as the daemon so that a
 * mnemonic generated here imports cleanly into triangles_v5.
 */
#ifndef TRI_PAPER_BIP39_ENGLISH_H
#define TRI_PAPER_BIP39_ENGLISH_H
...
"bedroom","beef","begin","behave","behind","believe","below","belt",
...
"evoke","evolve","exact","example","excess","exchange","excite","exist",
...
"gravity","great","green","grid","grief","grit","grocery","ground",
...
"home","honey","hood","hope","horn","horse","hospital","host",
"hot","hotel","hour","hover","hub","huge","human","humble",
...
"jail","jam","january","jar","jazz","jealous","jeans","jelly",
"jewel","job","join","joke","journey","joy","judge","juice",
"jumble","jumbo","jump","junction","jungle","junior","junk","just",
...
"laugh","laundry","lava","law","lawn","layer","lazy","leader",
...
"like","limb","lime","limit","link","lion","liquid","list",
"little","live","lizard","load","loan","lobster","local","lock",
"log","logic","lonely","long","loop","lottery","loud","lounge",
...
"museum","mushroom","music","must","mutual","myself","mystery","naive",
...
"professor","profile","profit","program","project","promote","proof","property",
...
"regret","regular","reject","relax","release","relief","remain","remember",
...
"rhythm","rib","rice","rich","ride","ridge","rifle","right",
"rigid","ring","riot","ripple","risk","ritual","rival","river",
"roach","road","roast","robot","robust","rocket","romance","roof",
...
"table","tackle","tag","tail","tale","talk","tank","tape",
...
"tourist","toward","tower","toy","track","trade","traffic","tragic",
...
"upper","upset","urban","urge","usage","used","useful","useless",
...
"wage","wagon","wait","walk","wall","want","warfare","warm",
